...
export default function AboutLayout() {
  ...
  return (
    <div className="flex flex-col items-center gap-y-16">
      <div className="flex w-full flex-col items-center rounded-md bg-gray-200 py-8">
      ...
      <div className="flex flex-1 flex-col items-center gap-y-8">
        ...
        <div className="flex flex-col gap-y-4">
          ...
          <div className="flex flex-col items-center gap-y-4">
            <div className="flex w-full flex-row items-center gap-x-4">
              <div className="h-[1px] flex-1 bg-gray-700" />
              <p className="text-normal scale-120 font-bold">{description[language].lookingfor}</p>
              <div className="h-[1px] flex-1 bg-gray-700" />
            </div>
      ...
      <div className="flex w-full flex-col items-center gap-y-8 rounded-md bg-gray-200 p-8">
